  ...
  .then(function (db) {
    ...
    function spawnDefaultCharts() {
      ...
      if (urlState && urlState.charts && urlState.charts.length > 0) {
        ...
        configsToSpawn = [
          { type: 'Диаграмма с накоплением по архивам', metric: 'Количество', w: '55vw', h: '45vh' },
          { type: 'Сетевой граф по адресам', metric: 'Количество', w: '30vw', h: '45vh' },
          
          { type: 'Диаграмма с накоплением по архивам', metric: 'Вес', w: '55vw', h: '45vh' },
          { type: 'Древовидная карта рубрик и подрубрик', metric: 'Количество', w: '30vw', h: '45vh' },
