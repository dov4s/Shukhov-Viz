export function spawnChart(){
	...
	addContainerBtn.addEventListener('click', function(){
		...
		const topChartGroups = {
			'Основные графики': {
				'Линейный график': ['Количество', 'Вес', 'Интенсивность'],
				'Диаграмма с накоплением по архивам': [
					'Количество','Вес','Интенсивность'
				],
			...
			'Диаграммы': {
				...
				'Диаграмма / Рубрика': ['Количество'],
				'Диаграмма / Подрубрика': ['Количество'],
				'Диаграмма / Дескрипторы': ['Количество'],
				'Диаграмма / Локация': ['Количество'],
				'Диаграмма / Вид документа': ['Количество'],
				'Диаграмма / Носитель': ['Количество'],
				'Диаграмма / Язык': ['Количество'],
				'Диаграмма / Наличие автографа': ['Количество'],
				'Диаграмма / Сведения о копийности': ['Количество'],
				'Диаграмма / Наличию цифровой копии': ['Количество'],
				'Диаграмма / Сведения о ценности': ['Количество'],
				'Диаграмма / Необходимость реставрации': ['Количество'],
			},
